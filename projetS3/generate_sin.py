...
def generate_signal(N,W1,W2,k,f) :	# Generates a list of N samples of a signal exclusively composed of pur sinus
	#N is the number of samples, W1 and W2 the minimum and maximum frequency of the signal, k is the frequency step and f is the sampling frequency
	A = list()
...
def generate_sinus(N,f,fe) : # Generates a list of N samples of a pur sinus

	A = list()
	for i in range(0,N) :
		A.append(1+sin(2*pi*f*i/fe))
